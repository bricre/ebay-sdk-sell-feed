...
class TaskCollection extends AbstractModel
{
     ...
     * to be submitted in the request, the parameter defaults to 10 if
     ...
     * make three separate <strong>getTasks</strong> calls to view all tasks matching
     * the input criteria.</span></p>.
     *
     * @var int
     */
    public $limit = null;
