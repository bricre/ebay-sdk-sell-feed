 ...
 * The response consists of 0 or more sequenced <em> pages</em> where each page has
 * 0 or more items.
 */
class UserScheduleCollection extends AbstractModel
{
     ...
     * which is the maximum number of schedules to return per page, from the result
     * set. A result set is the complete set of schedules returned by the method. <p>
     * <span class="tablenote"><strong>Note:</strong> Though this parameter is not
     * required to be submitted in the request, the parameter defaults to 10 if
     * omitted.<p> <span class="tablenote"><strong>Note:</strong> If this is the last
     * or only page of the result set, the page may contain fewer tasks than the
     * <strong>limit</strong> value. To determine the number of pages in a result set,
     * divide the total value (total number of tasks matching input criteria) by this
     * limit value, and then round up to the next integer. For example, if the
     ...
     * make three separate <strong>getSchedules</strong> calls to view all tasks
     * matching the input criteria.</span></p></span></p>.
     *
     * @var int
     */
    public $limit = null;
