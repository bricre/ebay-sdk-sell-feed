...
class CustomerServiceMetricTaskCollection extends AbstractModel
{
     ...
     * which is the maximum number of tasks to return per page, from the result set. A
     * result set is the complete set of tasks returned by the method. <p> <span
     * class="tablenote"><strong>Note:</strong> Even though this parameter is not
     ...
     * the limit value. To determine the number of pages in a result set, divide the
     * total value (total number of tasks matching input criteria) by this limit value,
     * and then round up to the next integer. For example, if the
     ...
     * make three separate <strong>getCustomerServiceMetricTasks</strong> calls to view
     * all tasks matching the input criteria.</span></p>.
     *
     * @var int
     */
    public $limit = null;
     ...
     * result. This value can be set in the request with the <b>offset</b> query
